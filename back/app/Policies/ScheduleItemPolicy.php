...
class ScheduleItemPolicy
{
    ...
    {
        return $user->hasAnyRole(['organizationManager', 'specialist']);
    }
    ...
    {
        return $user->hasAnyRole(['organizationManager', 'specialist']) && $user->organization->id === $scheduleItem->organization->id;
    }
    ...
    {
        return $user->hasAnyRole(['organizationManager']) && $user->organization->id === $scheduleItem->organization->id;
    }
