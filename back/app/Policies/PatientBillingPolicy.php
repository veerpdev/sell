...
class PatientBillingPolicy
{
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $user, PatientBilling $patientBilling)
    {
        return $user->hasAnyRole(['organizationManager', 'receptionist', 'anesthetist', 'specialist']) && $patientBilling->patient->isPartOfOrganization($user->organization->id);
    }
